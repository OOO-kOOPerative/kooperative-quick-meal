...
Краткое наименование программы - "Quick Meal".
...
Исходя из вышесказанного, областью применения мобильного приложения "Quick Meal" будут контроль питания и помощь при заказе подходящих продуктов.
...
Условное обозначение темы разработки -- "Quick Meal".
